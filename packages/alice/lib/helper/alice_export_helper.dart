  ...
  static String _buildCallLog({
    ...
    final StringBuffer stringBuffer =
        StringBuffer()..writeAll([
          ...
          '--------------------------------------------\n',
          '${context.i18n(AliceTranslationKey.saveLogRequestTime)} ${call.request?.time.toLocal().toIso8601String()}\n',
    ...
    stringBuffer.writeAll([
      ...
      '--------------------------------------------\n',
      '${context.i18n(AliceTranslationKey.saveLogResponseTime)} ${call.response?.time.toLocal().toIso8601String()}\n',
